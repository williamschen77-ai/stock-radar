export const STOCK_MAP = {
  ...
  "5274":{ name:"信驊",     sector:"IC設計" },
  "6533":{ name:"晶心科",   sector:"IC設計" },
  "3443":{ name:"創意",     sector:"IC設計" },
  "2344":{ name:"華邦電",   sector:"記憶體" },
  "3141":{ name:"晶宏",     sector:"IC設計" },
  "3006":{ name:"晶豪科",   sector:"記憶體" },
  "5347":{ name:"世界",     sector:"半導體" },
  "4915":{ name:"致伸",     sector:"電子" },
  // 伺服器/AI
  "2382":{ name:"廣達",     sector:"伺服器" },
  "6669":{ name:"緯穎",     sector:"伺服器" },
  "3231":{ name:"緯創",     sector:"伺服器" },
  "2356":{ name:"英業達",   sector:"伺服器" },
  "2301":{ name:"光寶科",   sector:"電子" },
  // 電子製造
  "2317":{ name:"鴻海",     sector:"電子製造" },
  "2354":{ name:"鴻準",     sector:"機殼" },
  ...
  "2915":{ name:"潤泰全",   sector:"零售" },
  "1213":{ name:"大飲",     sector:"食品" },
  // 航運
  "2603":{ name:"長榮",     sector:"航運" },
  "2609":{ name:"陽明",     sector:"航運" },
  "2615":{ name:"萬海",     sector:"航運" },
  "2610":{ name:"華航",     sector:"航空" },
  "2618":{ name:"長榮航",   sector:"航空" },
  // 生技醫療
  "4147":{ name:"中裕",     sector:"生技" },
  "6547":{ name:"高端疫苗", sector:"生技" },
  "1789":{ name:"神隆",     sector:"製藥" },
  "4152":{ name:"台微體",   sector:"生技" },
  "6235":{ name:"華孚",     sector:"生技" },
  "1776":{ name:"展宇",     sector:"生技" },
  // 其他科技
  "3017":{ name:"奇鋐",     sector:"散熱" },
  "6456":{ name:"GIS-KY",   sector:"觸控" },
  "2344":{ name:"華邦電",   sector:"記憶體" },
  "3481":{ name:"群創",     sector:"面板" },
  "2409":{ name:"友達",     sector:"面板" },
  "2207":{ name:"和泰車",   sector:"汽車" },
  "2105":{ name:"正新",     sector:"輪胎" },
  // ETF
  "0050":{ name:"元大台灣50",       sector:"ETF" },
  "0056":{ name:"元大高股息",        sector:"ETF" },
  "00878":{ name:"國泰永續高股息",   sector:"ETF" },
  "00881":{ name:"國泰台灣科技龍頭", sector:"ETF" },
  "006208":{ name:"富邦台50",        sector:"ETF" },
  "00891":{ name:"中信關鍵半導體",   sector:"ETF" },
  "00892":{ name:"富邦台灣半導體",   sector:"ETF" },
  ...
  "00944":{ name:"野村趨勢動能高息", sector:"ETF" },
  "00946":{ name:"群益科技高息成長", sector:"ETF" },
  "00886":{ name:"永豐美國科技",     sector:"ETF" },
};
...
export function searchStock(query) {
  ...
  const exact = STOCK_MAP[q];
  if (exact) return [{ code: q, ...exact }];
